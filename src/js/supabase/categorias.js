export async function cargarCategorias(supabase) {
  ...
  data.forEach((element) => {
    ...
    divCategorias.href = `/src/pages/categorias.html?categoriaId=${element.id}&categoriaName=${encodeURIComponent(element.nombre)}&categoriaDescripcion=${encodeURIComponent(element.descripcion)}`;
